      ...
      builder: (ctrl) => Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(children: [
            ...
            // ✅ Stats — based on current tab's FILTERED list (was activeTabList,
            // which ignored site/client/priority filters and caused the
            // "405 vs 4" mismatch reported in QA)
            _StatsRow(ctrl: ctrl, list: ctrl.filteredTaskList),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            // ✅ was ctrl.assignedToMeList.length (unfiltered total)
                            // now reflects currently applied filters, per tab
                            '${ctrl.filteredAssignedToMeCount}',
                            style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.w700,
                              color: ctrl.selectedTabIndex == 0
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            // ✅ was ctrl.assignedByMeList.length (unfiltered total —
                            // this is what showed 405 instead of 4 in QA report)
                            '${ctrl.filteredAssignedByMeCount}',
                            style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.w700,
                              color: ctrl.selectedTabIndex == 1
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: ctrl.taskFilterOptions.map((filter) {
                    final isSelected = ctrl.selectedTaskFilter == filter;
                    // ✅ was ctrl.activeTabList (ignored site/client/priority/
                    // status filters) — now uses filteredTaskListForChips,
                    // which applies every other active filter but not the
                    // flag filter itself, so chip counts match reality.
                    final count = filter == 'All'
                        ? ctrl.filteredTaskListForChips.length
                        : ctrl.filteredTaskListForChips
                        .where((t) => t.flag == filter)
                        .length;
                    return Padding(
                      padding: const EdgeInsets.only(right: 5),
